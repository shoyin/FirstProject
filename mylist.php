...
$sqls = "select * from content where uid='$userid'";
...
//获取信息
$sqls = "select * from content where uid='$userid' order by istop desc,ishot desc,isjinghua desc,postime desc limit $offset,$pagesize";
$results = mysql_query($sqls);
