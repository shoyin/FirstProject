	...
	<div class="top ul li ">
		...
		<div>
				<table>
						<tr>
							<td class=td1>用户名：</td>
							<td class=td2><input type="text" name="username" id="" size=35><a href="user/register.php">立即注册</a></td>
							
						</tr>	
						<tr>
							<td class=td1>密码：</td>
							<td class=td2><input type="password" name="pwd" id="" size=35><a href="#">找回密码</a></td>
							
						</tr>	
						<tr>
							<td class=td1>安全提问：</td>
							<td class=td2>
								<select>
								    <option value="安全提问（未设置请忽略）">安全提问（未设置请忽略）</option>
						...
						<tr>
							<td class=></td>
							<td class=td5>
							      <input type="checkbox" name="" id="">自动登陆<br/>
